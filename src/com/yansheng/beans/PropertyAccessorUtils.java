...
public abstract class PropertyAccessorUtils {
    ...
    public static boolean isNestedOrIndexedProperty(String propertyPath) {
        ...
        for (int i = 0; i < propertyPath.length(); i++) {
            ...
            if (ch == PropertyAccessor.NESTED_PROPERTY_SEPARATOR_CHAR ||
                    ch == PropertyAccessor.PROPERTY_KEY_SUFFIX_CHAR) {
                return true;
            }
        }
        return false;
    ...
    public static int getFirstNestedPropertySeparatorIndex(String peopertyPath) {
        return getNestedPropertySeparatorIndex(peopertyPath, false);
    }

    public static int getLastNestedPropertySeparatorIndex(String peopertyPath) {
        return getNestedPropertySeparatorIndex(peopertyPath, true);
    }
