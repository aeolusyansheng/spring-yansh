...
public class URIEditor extends PropertyEditorSupport {
    ...
    public void setAsText(String text) {
        if (StringUtils.hasText(text)) {
            ...
            if (this.classLoader != null && text.startsWith(ResourceUtils.CLASSPATH_URL_PREFIX)) {
                ...
                try {
                    ...
                    throw new IllegalArgumentException("无法将资源" + resource + "转换成URL", e);
                } catch (URISyntaxException e) {
                    throw new IllegalArgumentException("无效的URI语法.", e);
                }
            } else {
                try {
