...
SELECT '0'                                      AS TSK_MK_SYS_SEG  -- 0：PJNavi,1：NextMI
     ...
     , '0'                                      AS VAC_FLG
     , NULL                                     AS ROW_ID1
     , WBS_TSK.ROWID                            AS ROW_ID2
     , PRJ.ROWID                                AS ROW_ID3
     , PRJ_NEXTMI_TSK.ROWID                     AS ROW_ID4
     , 2                                        AS marker
...
COMMENT ON COLUMN PJVR_MI_TSK_UNI.ROW_ID4 IS 'ROW_ID4';
COMMENT ON COLUMN PJVR_MI_TSK_UNI.marker IS 'マーカー';
