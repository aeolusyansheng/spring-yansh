...
SELECT PRJ.PRJ_CD                           AS PRJ_CD
     ...
     , PRJ_ICDT_INFO.ROWID                  AS ROW_ID4
     , PRJ_TPL.ROWID                        AS ROW_ID5
     , 2                                    AS marker
...
COMMENT ON COLUMN PJVR_MI_PRJ_UNI.ROW_ID4 IS 'ROW_ID4';
COMMENT ON COLUMN PJVR_MI_PRJ_UNI.ROW_ID5 IS 'ROW_ID5';
COMMENT ON COLUMN PJVR_MI_PRJ_UNI.marker IS 'マーカー';
